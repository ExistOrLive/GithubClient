...
@objcMembers class ZLNotificationServiceModel: ZLBaseServiceModel,ZLNotificationServiceModuleProtocol {
    ...
    static public func sharedInstance() ->ZLNotificationServiceModel{
        return shared
    }
    
    public func getNoticaitions(showAll: Bool, page: UInt, per_page: UInt, serialNumber : String, completeHandle: ((ZLOperationResultModel) -> Void)?) {
    ...
    public func markNotificationRead(notificationId: String, serialNumber : String, completeHandle: ((ZLOperationResultModel) -> Void)?) {
