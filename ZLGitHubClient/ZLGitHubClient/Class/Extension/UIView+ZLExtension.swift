...
extension UIView {
    ...
    func showPopMenuView(titles: [String]?,
        ...
        let menuView = FWMenuView.menu(itemTitles: titles, itemImageNames: images, itemBlock: { popupView, index, title in
    ...
    func showShareMenu(title: String,
        ...
        let alertAction5 = UIAlertAction.init(title: ZLLocalizedString(string: "Copy URL", comment: ""), style: UIAlertAction.Style.default) { (action : UIAlertAction) in
        ...
        let alertAction3 = UIAlertAction.init(title: ZLLocalizedString(string: "Share", comment: ""), style: UIAlertAction.Style.default) { [weak self] (action : UIAlertAction) in
