...
typedef NS_OPTIONS(NSUInteger, CornerDirection) {
    CornerDirectionLeftTop = 1U << 0,
    CornerDirectionRightTop = 1U << 1,
    CornerDirectionLeftBottom = 1U << 2,
    CornerDirectionRightBottom = 1U << 3,
};
...
/// 圆角方向
@property(nonatomic, assign) CornerDirection cornerDirection;
...
///是否开启主题渐变风格
///(很多APP渐变风格大多数都是一致了.为了更快设置颜色而添加的属性,具体用法实现UIView+Theme方法)
