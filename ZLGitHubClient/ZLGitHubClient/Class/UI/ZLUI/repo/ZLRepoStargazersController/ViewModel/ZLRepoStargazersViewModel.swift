...
extension ZLRepoStargazersViewModel
{
    func loadNewData()
    {
        ...
        ZLRepoServiceModel.shared().getRepoStargazers(withFullName: self.fullName!, serialNumber: NSString.generateSerialNumber()) { (resultModel : ZLOperationResultModel) in
