//
//  ZLAppearanceView.swift
//  ZLGitHubClient
//
//  Created by 朱猛 on 2021/11/27.
//  Copyright © 2021 ZM. All rights reserved.
//

import UIKit

protocol ZLAppearanceViewDelegate: AnyObject {
    var selectIndex: Int {get}
    func onButtonClicked(index: Int)
}


class ZLAppearanceView: UIView {
    ...
    private lazy var buttons: [UIButton] = {
        ...
        button2.setTitle(ZLLocalizedString(string: "Light Mode", comment: ""), for: .normal)
        ...
        button3.setTitle(ZLLocalizedString(string: "Dark Mode", comment: ""), for: .normal)
    ...
    private weak var delegate: ZLAppearanceViewDelegate?
    ...
    func fillWithData(data: ZLAppearanceViewDelegate) {
        self.delegate = data
