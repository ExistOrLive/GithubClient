...
class ZLRepoStargazersController: ZMTableViewController {
    ...
    override func setupUI() {
        ...
        title = ZLLocalizedString(string: "star", comment: "")
...
extension ZLRepoStargazersController {
    ...
    func loadData(isLoadNew: Bool) {
        ...
        ZLRepoServiceShared()?.getRepoStargazers(withFullName: repoFullName ?? "",
